...
CATEGORIES = {
    ...
    "gestion":        ["gestión","protocolo","checklist","calidad","simulación","formación","crisis","comunicación","trabajo en equipo","hemorragia masiva","recuperación intensificada","dynamed","novedades en anestesia","grupos de trabajo","comisiones","medioambiental","idisba","investigación","desfibrilador","bioconect"],
    "seguridad":      ["seguridad del paciente","sensar","notificación de incidente","incidente crítico","error médico","evento adverso","cultura de seguridad","hipotermia perioperatoria","checklist quirúrgico"],
    "orl_cmf":        ["otorrinolaringolog","amigdalectom","adenoidect","maxilofacial","cmf ","orl ","faringolaringoscop","tiroides orl","parotid","cirugía oral","sinusitis","nasosinusal","septoplastia","rinoplastia"],
